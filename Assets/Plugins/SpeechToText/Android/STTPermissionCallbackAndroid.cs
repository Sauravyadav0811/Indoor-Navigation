...
namespace SpeechToTextNamespace
{
    public class STTPermissionCallbackAndroid : AndroidJavaProxy
    {
        ...
        public STTPermissionCallbackAndroid(object threadLock)
            : base("com.yasirkula.unity.SpeechToTextPermissionReceiver")
        {
            Result = -1;
    ...
    public class STTPermissionCallbackAsyncAndroid : AndroidJavaProxy
    {
        ...
        public STTPermissionCallbackAsyncAndroid(SpeechToText.PermissionCallback callback)
            : base("com.yasirkula.unity.SpeechToTextPermissionReceiver")
        {
